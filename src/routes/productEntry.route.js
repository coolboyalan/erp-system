...
router
  ...
  .post(asyncHandler(ProductEntryController.create.bind(ProductEntryController)))
  .put(asyncHandler(ProductEntryController.update.bind(ProductEntryController)))
  .delete(asyncHandler(ProductEntryController.deleteDoc.bind(ProductEntryController)));
